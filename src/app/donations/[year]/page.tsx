...
async function getDonations(taxYearId: string) {
    try {
        ...
        const records = await pb.collection('donations').getFullList({
            ...
            expand: 'charity', // Expand relation
        })
        return records
    } catch (e) {
        return []
            ...
            <div className="flex items-center space-x-4 mb-6">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-muted-foreground text-sm">
                        CPI: {taxYear.target_cpi} • Inflation Multiplier: {multiplier}x
                    </p>
                </div>
                            ...
                            <Card className="hover:border-primary transition-colors cursor-pointer h-full">
                                ...
                                <CardContent>
                                    <div className="text-sm text-muted-foreground">
                                        {/* TODO: Add item count summary here later */}
                                        Click to manage items & photos
                                    </div>
                                </CardContent>
                            </Card>
                        </Link>
